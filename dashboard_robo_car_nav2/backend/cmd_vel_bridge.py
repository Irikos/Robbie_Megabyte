...
sport_client.move_to() din robot_client.py, exclusiv prin mesaje ROS 2.
...
from nav2_engine import _EngineNode
...
def main():
    rclpy.init()
    transport = _EngineNode()
    sport_client.initialize_ros(transport)
    node = CmdVelBridge()
