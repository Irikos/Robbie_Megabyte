...
Argumente utile (ca înainte): `--teleop-bridge`, `--repair-native-slam`.
...
- Comportamentul teleop: a rămas pe SDK-ul mașinii (nu prin Nav2). Nu e
  „navigare", dar testează-l separat înainte de autonomie.
