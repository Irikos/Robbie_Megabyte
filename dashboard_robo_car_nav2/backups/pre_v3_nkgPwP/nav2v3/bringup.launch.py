...
def generate_launch_description():
    ...
    # Orice nod mort invalidează pipeline-ul. Nu lăsa ceilalți participanți
    # orfani dacă lifecycle_manager sau alt proces eșuează la inițializare.
    return LaunchDescription([
        RegisterEventHandler(OnProcessExit(on_exit=[
            Shutdown(reason="Un proces Nav2 s-a oprit; închid întregul bringup")
        ])),
        *navigation_nodes,
    ])
