...
if (suppliedToken) sessionStorage.setItem("g1_dashboard_nav2_v3_token", suppliedToken);
const token = suppliedToken || sessionStorage.getItem("g1_dashboard_nav2_v3_token") || "";
