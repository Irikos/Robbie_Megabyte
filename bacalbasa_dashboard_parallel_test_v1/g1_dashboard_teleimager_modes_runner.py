...
def _patched_rs_update_frame(self):
    ...
    if not getattr(self, "_g1_yolo_client_initialized", False):
        ...
        # Full Dash uses this runner specifically for the
        # RealSense camera. Do not suppress the proven Dragos
        # YOLO client merely because Teleimager supplied a
        ...
        try:
            ...
            image_server.logger_mp.info(
                "[G1 YOLO] Full Dash client ready: cam_topic=%s",
                getattr(self, "_g1_cam_topic", ""),
            )
